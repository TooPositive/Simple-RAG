...
**Special Thanks**: Mr. Tomato for the inspiration! 🍅
...
### For Ciklum AI Academy Mentors
- **GitHub Repository**: [TooPositive/Simple-RAG](https://github.com/TooPositive/Simple-RAG)
- **Demo Video**: [Link to 5-min demo video]
- **LinkedIn Post**: [Link to agent-generated LinkedIn post]
